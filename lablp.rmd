...
# y1* = 450 y2*= 0 y3*= 700 y4*=-17,5 y5*=0 y6*=0 y7*=0 y8*=0


* Interpreta itzazu $y^*_1$ eta $y^*_2$ itzal-prezioak.


# y1*=450  --> ereduaren lehenengo baliabideari buruz, esaten digu (nitratoa) unitate bat gehiago edukiko bagenu, irabazia 450
# unitate hartuko dituela

# y2*=0 --> 2. baliabidearekin lotuta dago. Fosfatoa, 1800 unitate ditugu. Komeni da fosfato unitate bat
# gutxiago erostea, irabazia mantenduko delako eta kostua gutxiagoa izango delako.

# Aldatu dugu fosfato kantitatea
...
# get constraints agindua bidez lortzen da:
# [1] 1001 1500 1200 6000
# Nitratoa: 0.05x1 + 0.05x2 + 0.1x3 <= 1000; --> 1000=1000
# Fosfatoa: 0.1x1 + 0.1x2 + 0.1x3 <= 1800 --> 1500 < 1800
# Potasa: 0.05x1 + 0.1x2 + 0.1x3 <= 1200 --> 1200 = 1200
# Eskaria: x1 >=6000; 6000=6000

# Sol. opt: 6000, 4000, 5000

# Nitratoa bere osotasunean erabiltzen ari gara, 1000 unitate ditugu eta guztiak erabiltzen dira soluzio optimoaren araberako ekoizpenean.

# Fosfatoa aldiz, 1500 unitate besterik ez dira erabiltzen, eta lantegiak 1800 ditu. 300 unitate soberan daude.
...
# Lehen ongarri mota kantitate berean ekoitziko da, baina bigarrena gutxiago (4000 -> 2000)
# era hirugarrena gehiago (5000 -> 7000). Irabazia ere aldatu da, berria: 1230000
...
# tartearen barruan dago, beraz, oinarria optimo mantenduko da, seguituko produktuak.
# Irabazia handitu da. Zentzua du, c3 orain 180 delako, unitateko irabazia handitu da.
...
#(IDATZI KODEA HEMEN)
solve(model.example)
get.sensitivity.rhs(model.example)
